...
def testRbf(k1 = 1.3):
    ...
    for i in range(m):  # 利用核函数分类
        ...
        predict = KernelEval.T * np.multiply(labelSV, alphas[svInd]) + b  # 根据支持向量的点，计算超平面，得到预测结果
